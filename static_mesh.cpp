...
// UNIT.13
void static_mesh::render(ID3D11DeviceContext* immediate_context, const XMFLOAT4X4& world, const XMFLOAT4& material_color, ID3D11PixelShader* replaced_pixel_shader/*UNIT.16*/)
{
